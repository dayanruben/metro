...
Metro's **runtime** and **Gradle plugin** APIs are stable and abide by semantic versioning. APIs marked as experimental are not covered by this guarantee and may change or be removed.
