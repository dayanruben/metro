...
internal fun IrElement.dumpKotlinLikeFallback(
...
private class BetterKotlinLikeDumper(
  ...
  private fun IrSimpleFunction.printAccessor(s: String, property: IrDeclaration) {
    // The origin constant's getter return type changed in Kotlin 2.3.20.
    val isCustomAccessor = origin.name != "DEFAULT_PROPERTY_ACCESSOR"
    printSimpleFunction(
      property,
      keyword = "",
      name = s,
