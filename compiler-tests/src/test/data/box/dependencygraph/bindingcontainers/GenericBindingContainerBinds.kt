// Reconstructing this @Binds declaration must keep its container receiver typed as AliasBindings<T>.
@BindingContainer
class AliasBindings<T : Any> {
  @Binds val T.bind: Any get() = this
}

// The private bindings also check nested types and the recursive Comparable<V> bound.
@BindingContainer
